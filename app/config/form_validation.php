...
//        ),
    ...
    'purchases/add_payment' => array(
        array(
            'field' => 'amount-paid',
            'rules' => 'required|numeric'
        )
    ),
    'system_setting/add_promo' => array(
        array(
            'field' => 'Judul',
            'label' => lang('Judul'),
            'rules' => 'required'
    ...
    'Official/registered' => array(
        array(
            'field' => 'reference_kode1',
            'label' => lang('reference_kode'),
