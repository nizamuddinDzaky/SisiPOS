 ...
 */
$config['site_title']                 = "Forca Pos";       // Site Title, example.com This is not more functional
$config['admin_email']                = "suuport@sisi.id"; // Admin Email, admin@example.com This is not more functional
