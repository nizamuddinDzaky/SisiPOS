...
class Socket_notifications extends MY_Controller
{
    public function __construct()
    {
        ...
        $this->lang->load('notifications', 'indonesian');
    }
    ...
    public function getNotifications(){
		...
		$config['base_url'] = base_url().'aksestoko/socket_notifications/getNotifications?company_id='.$company_id.'&row='.($this->input->get('row')+5);
    ...
    public function createMessageNotification($data){
        ...
        $notification_message['date']                       = $data['created_at'];
