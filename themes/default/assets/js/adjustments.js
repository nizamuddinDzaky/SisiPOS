...
//            console.log(localStorage.getItem('qaitems_temp'));
//            $(document).on('click', 'i', function () {
//                var str_itemId=$(this).closest('tr').attr('data-item-id');
//                var a=JSON.parse(localStorage.getItem('qaitems_temp'));
//                if(a.data){
...
//                                delete a.data[i];
//                                localStorage.setItem('qaitems_temp', JSON.stringify(a));
//                            }
//                        }
//                    }
//                }
...
function check_item_local_storage(item) {
    qaitems = JSON.parse(localStorage.getItem('qaitems'));
    let flag = true;
    if (qaitems != null && Object.keys(qaitems).length > 0) {
        jQuery.each(qaitems, function (i, val) {
...
//    }
//
//    if(localStorage.getItem('qaitems_temp')){
//        qaitems_temp=JSON.parse(localStorage.getItem('qaitems_temp'));
//        var total=0;var contain=0;
//        for(var i=0;i<Object.keys(qaitems_temp.data).length;i++){
//            if(qaitems_temp.data[i]==null){
//                contain++;
//            }total++;
//        }
//        if(total==contain){
...
//
//    var flag=0;
//    var count=Object.keys(qaitems_temp.data).length;
//    if(count==0){
//        qaitems_temp.data.push({ 
//            "trx_id"        : item.id,
//            "product_id"    : item.item_id
//        });
//    }else{
//        for(var i=0;i<count;i++){
//            var obj=qaitems_temp.data[i];
//            if(obj==null){
//                continue;
//            }else{
//                if(obj.product_id==item.item_id){
//                    qaitems[obj.trx_id].row.qty = parseFloat(qaitems[obj.trx_id].row.qty) + 1;
//                    delete qaitems[item_id];
//                    flag=0;
//                    break;
//                }
...
//
//    localStorage.setItem('qaitems', JSON.stringify(qaitems));
//    localStorage.setItem('qaitems_temp', JSON.stringify(qaitems_temp));
//    loadItems();
//    return true;
    // if (count == 1) {
    ...
    if (!check_item_local_storage(item)) {
        bootbox.alert(lang.item_adjusment_duplicated, function () {});
    } else {
        if (count == 1) {
            qaitems = {};
        }
...
//    localStorage.removeItem('qaitems_temp');
//    localStorage.removeItem('qatrash');
//});