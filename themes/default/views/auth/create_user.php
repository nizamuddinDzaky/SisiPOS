...
<div class="box">
    <div class="box-header">
        ...
        <div class="box-icon">
            <?php echo anchor($mb_create_user, '<i class="icon fa fa-book tip" data-placement="left" title="'.lang("manual_book").'"></i> ', 'target="_blank"') ?>
        </div>
    </div>
                    ...
                    <div class="col-md-12">
                        <div class="col-md-5">
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <?php echo form_input('company', $this->session->userdata('company_name'), 'class="form-control" id="company" required="required" readonly="readonly"' ); ?>
                                </div>
                            </div>
                            ...
                            <div class="form-group" style="display:none">
                                ...
                                <div class="controls">
                                    <input type="text" id="username" name="username" class="form-control"
                                           required="required" pattern=".{4,20}" readonly="readonly"/>
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="col-md-5 col-md-offset-1">
                            ...
                            <div>
                                <div class="form-group">
                                    ...
                                    echo form_dropdown('biller', $bl, (isset($_POST['biller']) ? $_POST['biller'] : $this->session->userdata('biller_id')), 'id="biller" required="required" class="form-control select" style="width:100%;"');
                                    ?>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    echo form_dropdown('warehouse', $wh, (isset($_POST['warehouse']) ? $_POST['warehouse'] :  $this->session->userdata('warehouse_id')), 'id="warehouse" required="required" class="form-control select" style="width:100%;" ');
                                    ?>
                                </div>
