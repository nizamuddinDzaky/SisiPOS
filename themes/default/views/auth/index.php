        ...
        <div class="box-icon">
            <ul class="btn-tasks">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li><a href="<?= $mb_users ?>" target="_blank"><i class="fa fa-book tip"></i> <?= lang('users') ?></a></li>
                        <li><a href="<?= $mb_edit_user ?>" target="_blank"><i class="fa fa-book tip"></i> <?= lang('edit_user') ?></a></li>
                    </ul>
                </li>
            </ul>
        </div>
