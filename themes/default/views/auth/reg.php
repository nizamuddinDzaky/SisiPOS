...
<head>
    ...
    <link href="<?= base_url() ?>assets/styles/theme.css?v=<?=FORCAPOS_VERSION?>" rel="stylesheet">
    <link href="<?= base_url() ?>assets/styles/style.css?v=<?=FORCAPOS_VERSION?>" rel="stylesheet">
    <link href="<?= base_url() ?>assets/styles/helpers/login.css?v=<?=FORCAPOS_VERSION?>" rel="stylesheet">
...
<script src="<?= base_url() ?>assets/js/custom.js?v=<?=FORCAPOS_VERSION?>"></script>
