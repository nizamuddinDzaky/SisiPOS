            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        company_id
                        <?php
                        $opts_company = array(1 => 'Company 1', 2=>'Company 2');
                        echo form_dropdown('company_id', $opts_company, '', 'class="form-control select" id="company_id" required="required" '); ?>
                    </div>
...
//if(localStorage.getItem('flag_url')){
//    localStorage.removeItem('flag_url');
//}
</script>
<?= $modal_js ?>
