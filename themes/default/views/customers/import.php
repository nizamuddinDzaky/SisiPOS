...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <?php if($Principal){ ?>
                <a href="<?php echo base_url(); ?>assets/csv/sample_customer_for_principal.csv" class="btn btn-primary pull-right"><i
                ...
                <span class="text-warning"><?= lang("csv1"); ?></span><br/><?= lang("csv2"); ?> <span class="text-info">(<?= lang("company") . ', ' . lang("name") . ', ' . lang("email") . ', ' . lang("phone") . ', ' . lang("address") . ', ' . lang("city"); ?>
                    ,  <?= lang("state") . ', ' . lang("postal_code") . ', ' . lang("country") . ', ' . lang("vat_no") . ', ' . lang("ccf1") . ', ' . lang("ccf2") . ', ' . lang("ccf3") . ', ' . lang("ccf4") . ', ' . lang("ccf5") . ', ' . lang("ccf6").', '.lang("Id_Distributor"); ?>
                    )</span> <?= lang("csv3"); ?><br>
            <?php }else{ ?>
