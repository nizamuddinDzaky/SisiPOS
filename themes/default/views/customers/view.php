        ...
        <div class="modal-body">
            <div class="table-responsive">
                <table class="table table-striped table-bordered" style="margin-bottom:0;">
                    ...
                    <tr>
                        <td><strong><?= lang("sales_person_code"); ?></strong></td>
                        <td><?= $sales_person ? $sales_person->reference_no : ""; ?></strong></td>
                    </tr>
                    <tr>
                        <td><strong><?= lang("sales_person"); ?></strong></td>
                        <td><?= $sales_person ? $sales_person->name : ""; ?></strong></td>
                    </tr>
                    <tr>
                ...
                <?php if($warehouse_customer){?>
                    <br>
                    <?php $w_default; foreach($warehouse_default as $row1){
                        $w_default = $row1->warehouse_name;
                    } ?>
                    <p><label><?= lang("warehouses"); ?></label><br>
                    ...
                    <div class="table-responsive">
                        <table id="CompTable" cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-hover table-striped">
                            ...
                            <tbody>
                                <?php foreach($warehouse_customer as $row){ ?>
                                    <tr>
                                        <td><?= $row->code; ?></td>
                                        <td><?= $row->name; ?></td>
                                        </tr>
