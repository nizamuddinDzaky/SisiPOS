...
<script>
    $(document).ready(function() {
        var cTable = $('#CusData').dataTable({
            ...
            'bProcessing': true,
            'bServerSide': true,
            'sAjaxSource': '<?= site_url('distributors/getDistributors') ?>',
...
<?php if ($Owner || $Admin || $Principal || $GP['bulk_actions']) {
    echo form_open('distributors/distributor_actions', 'id="action-form"');
} ?>
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-users"></i><?= lang('distributors'); ?></h2>
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <?php if ($Principal || $GP['bulk_actions']) { ?>
                            <li>
            ...
            <div class="col-lg-12">
                ...
                <div class="table-responsive">
                    <table id="CusData" cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-condensed table-hover table-striped">
                        <thead>
                            <tr class="primary">
                                <th style="max-width: 15px; text-align: center;">
