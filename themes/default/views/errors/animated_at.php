    ...
    <style type="text/css">
        *{
        ...
        #parent {
            ...
            height: 100vh;
            display: table;
            background-image: linear-gradient(to bottom, rgba(0, 0, 0, 0.1) 0%, rgba(0, 0, 0, 0.1) 100%), url('<?=$assets_at?>img/bg-sign.jpg');
        ...
        #snackbar {
            ...
            background-color:#b20838; /* Black background color */
    ...
    <div id="parent">
        <div id="child">
            ...
            <div class="wrapper">
                ...
                <a href="<?php echo $site_url; ?>"><button class="btn-l">Home</button></a>
            </div>
            <div class="wrapper footer" style="white">
                <img src="<?php echo $assets_at . 'img/logo-at-putih.png'?>" alt="AksesToko" width="80"/>
                <br>
                <small>Developed by SISI © <?=date('Y')?></small>
            </div>
        </div>
    </div>
