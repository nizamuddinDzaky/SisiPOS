...
<head>
    ...
    <link rel="stylesheet" href="<?=$assets?>styles/theme.css?v=<?=FORCAPOS_VERSION?>" type="text/css"/>
    <link rel="stylesheet" href="<?=$assets?>styles/style.css?v=<?=FORCAPOS_VERSION?>" type="text/css"/>
    <link rel="stylesheet" href="<?=$assets?>pos/css/posajax.css?v=<?=FORCAPOS_VERSION?>" type="text/css"/>
    <link rel="stylesheet" href="<?=$assets?>pos/css/print.css?v=<?=FORCAPOS_VERSION?>" type="text/css" media="print"/>
        ...
        <div class="container">
            ...
            <div class="header-nav">
                ...
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="dropdown">
                        <a class="btn bdarkGreen pos-tip" id="register_details" title="<span><?=lang('register_details')?></span>" data-placement="bottom" data-html="true" href="<?=site_url('pos/register_details')?>" data-toggle="modal" data-target="#myModal"  data-backdrop="static">
                            <i class="fa fa-check-circle"></i>
                        </a>
                    </li>
                    <li class="dropdown">
                        <a class="btn borange pos-tip" id="close_register" title="<span><?=lang('close_register')?></span>" data-placement="bottom" data-html="true" href="<?=site_url('pos/close_register')?>" data-toggle="modal" data-target="#myModal"  data-backdrop="static">
                            <i class="fa fa-times-circle"></i>
                        </a>
                    </li>
                    <li class="dropdown">
                        <a class="btn borange pos-tip" id="add_expense" title="<span><?=lang('add_expense')?></span>" data-placement="bottom" data-html="true" href="<?=site_url('purchases/add_expense')?>" data-toggle="modal" data-target="#myModal"  data-backdrop="static">
                            <i class="fa fa-dollar"></i>
                        </a>
                    </li>
                    <?php if ($Owner) {?>
                        <li class="dropdown">
                            <a class="btn bdarkGreen pos-tip" id="today_profit" title="<span><?=lang('today_profit')?></span>" data-placement="bottom" data-html="true" href="<?=site_url('reports/profit')?>" data-toggle="modal" data-target="#myModal"  data-backdrop="static">
                    ...
                    <?php if ($Owner || $Admin) {?>
                        <li class="dropdown">
                            <a class="btn bdarkGreen pos-tip" id="today_sale" title="<span><?=lang('today_sale')?></span>" data-placement="bottom" data-html="true" href="<?=site_url('pos/today_sale')?>" data-toggle="modal" data-target="#myModal"  data-backdrop="static">
                        ...
                        <div id="print">
                            ...
                            <div id="left-bottom">
                                <table id="totalTable"
                                    ...
                                    <tr>
                                        <td style="padding: 5px 10px;border-top: 1px solid #DDD;"><?=lang('total_point');?></td>
                                        <td class="text-right" style="padding: 5px 10px;font-size: 14px; font-weight:bold;border-top: 1px solid #DDD;">
                                            <span id="tpoint">0</span>
                                        </td>
                                        <td style="padding: 5px 10px;border-top: 1px solid #DDD;"><?=lang('point');?></td>
                                        <td class="text-right" style="padding: 5px 10px;font-size: 14px; font-weight:bold;border-top: 1px solid #DDD;">
                                            <span id="point">0</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 5px 10px;"><?=lang('gross_price');?></td>
                                        <td class="text-right" style="padding: 5px 10px;font-size: 14px; font-weight:bold;">
                                            <span id="gprice">0</span>
                                        </td>
                                    ...
                                    <tr>
                                        <td style="padding: 5px 10px;"><?=lang('shipping');?>
                                            <a href="#" id="ppshipping">
                                                <i class="fa fa-edit"></i>
                                            </a>
                                        </td>
                                        <td class="text-right" style="padding: 5px 10px;font-size: 14px; font-weight:bold;">
                                            <span id="tsp">0.00</span>
                                        </td>
...
<!--                                    <tr>
                                        <td style="padding: 5px 10px;" colspan="2"><?=lang('total');?></td>
                                        <td class="text-right" style="padding: 5px 10px;font-size: 14px; font-weight:bold;" colspan="2">
                                ...
                                <div id="botbuttons" class="col-xs-12 text-center">
                                    <input type="hidden" name="biller" id="biller" value="<?= ($Owner || !$this->session->userdata('biller_id')) ? $pos_settings->default_biller : $this->session->userdata('biller_id')?>"/>
                                    <div class="row">
                                ...
                                <div id="payment-con">
                                    <?php for ($i = 1; $i <= 5; $i++) {?>
                                        ...
                                        <input type="hidden" name="input_point[]" id="input_point_val_<?=$i?>" value=""/>
                                    <?php }
                                    ?>
                                </div>
                                ...
                                <input name="shipping" type="hidden" value="<?=$suspend_sale ? $suspend_sale->shipping : '';?>" id="posshipping">
...
//        	if (!empty($subcategories)) {
        	    foreach ($subcategories as $category) {
					// if($category->company_id==$this->session-userdata('company_id') ){
            ...
            <div class="modal-body" id="payment_content">
                <div class="row">
                    <div class="col-md-10 col-sm-9">
                        <?php if ($Owner || !$this->session->userdata('biller_id')) { ?>
                            <div class="form-group">
                                <?=lang("biller", "biller");?>
                                <?php
                                        ...
                                        <div class="col-sm-5">
                                            <div class="form-group">
                                                ...
                                                <input name="amount[]" type="text" id="amount_1"
                                                       class="pa form-control kb-pad1 amount number-only"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-11">
                                            ...
                                            <div class="pcc_1" style="display:none;">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <input name="cc_no[]" type="text" id="pcc_no_1" pattern=".{3,}"
                                            ...
                                            <div class="form-group ppoint_1" style="display: none;">
                                                <?=lang("point", "input_point_1");?>
                                                <input name="input_point[]" type="text" id="input_point_1"
                                                       class="form-control number-only input_point"/>
                                            </div>
                                            <div class="form-group">
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="spModalLabel"><?=lang('edit_order_shipping');?></h4>
            </div>
            <div class="modal-body">
                <div class="form-group">
                <?php $spCost=array('entry'=>'Enter Cost','maps'=>'Shipping Cost');
                echo form_dropdown('spCost', $spCost, "", 'id="spCost" class="form-control kb-pad"');?>
                </div><br>
                <div class="form-group maps">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <?=lang("shipping_charges", "shipping");?>
                                <input type="text" class="form-control" readonly id="shipping" name="shipping">
                            </div>
                            <div class="form-group">
                                <?=lang("enter_address", "destination");?>
                                <!--<div class="input-group">-->
                                    <input type="text" id="destination" name="destination" class="form-control">
<!--                                    <span class="input-group-addon pointer" id="browse_loc" onclick="calculateDistances('<?=$user->address?>','<?=$user->city?>');" style="padding: 1px 10px;">
                ...
                <div class="form-group entry-data">
                    <?=lang("order_shipping", "order_shipping_input");?>
                    <?php echo form_input('order_shipping_input', '', 'class="form-control kb-pad" id="order_shipping_input"'); ?>
                </div>
<!--                <div class="form-group">
                    <?=lang("order_shipping", "order_shipping_input");?>
                    <?php echo form_input('order_shipping_input', '', 'class="form-control kb-pad" id="order_shipping_input"'); ?>
            ...
            <div class="modal-footer">
                <button type="button" id="updateOrderShipping" class="btn btn-primary"><?=lang('update')?></button>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
var site = <?=json_encode(array('base_url' => base_url(), 'settings' => $Settings, 'dateFormats' => $dateFormats, 'key_maps' => _KEY_MAP))?>, pos_settings = <?=json_encode($pos_settings);?>;
...
<script type="text/javascript">
    ...
    var cust_group, position_user, position_customer;
    ...
    $(document).ready(function () {
        detail_biller=getDataCompany($('#posbiller').val());
        position_user={'lat':parseFloat(detail_biller.latitude),'lng':parseFloat(detail_biller.longitude)};
       ...
       // $.ajax({
       //     type: "get", async: false,
       //     url: "<?=site_url('pos/ajaxproducts')?>/" + $(element).val(),
       //     dataType: "json",
        //    success: function (data) {
        //        console.log(data);
        //    }
     ...
     */    
        $('#poscustomer').change(function(){
            detail_customer = getDataCompany($(this).val());
            $('#tpoint').text(detail_customer.award_points);
            localStorage.setItem('earnedpoint',detail_customer.award_points);
            $('.paid_by').select2('destroy');
            hasPoint = !! $('.paid_by > option[value="point"]').length;
            if(detail_customer.award_points!=0){
                $('.input_point').attr("max", detail_customer.award_points);
                (!hasPoint?$('.paid_by').append('<option value="point">point</option>'):'');
            }else{
                (hasPoint?$(".paid_by option[value='point']").remove():'');
            }
            $('.paid_by').select2({minimumResultsForSearch: 7});
            position_customer={'lat':detail_customer.latitude,'lng':detail_customer.longitude};
...
//        localStorage.setItem('trash',JSON.stringify(<?=$rand_id?>));
//        var d=JSON.parse(localStorage.getItem('trash'));
//        for (var i = 0; i < Object.keys(d).length; i++) {
//            positems_temp.data.push({
//                "trx_id"        : d[i].trx_id,
//                "product_id"    : d[i].product_id
//            });
//        }
//        localStorage.setItem('positems_temp', JSON.stringify(positems_temp));
        <?php } ?>
...
//        }
//        if (localStorage.getItem('positems_temp')) {
//            localStorage.removeItem('positems_temp');
//        }
        if(localStorage.getItem('earnedpoint')){
            localStorage.removeItem('earnedpoint');
        }
        if(localStorage.getItem('grossitems')){
            localStorage.removeItem('grossitems');
        }
...
<?php if ($this->input->get('customer')) {?>
        ...
        if(localStorage.getItem('earnedpoint')){
            $('#tpoint').text(localStorage.getItem('earnedpoint'));
            $('.paid_by').select2('destroy');
            $('.paid_by').append('<option value="point">point</option>').select2({minimumResultsForSearch: 7});
        }
        ...
        $('#paymentModal').on('change', '#input_point_<?=$i?>', function (e) {
            $('#input_point_val_<?=$i?>').val($(this).val());
        });
        <?php }
        ?>
        ...
        $('#payment').click(function () {
            ...
            <?php }
            ?>
            var twt = formatDecimal((total + invoice_tax) - order_discount + formatDecimal(shipping));
            if (count == 1) {
        ...
        $(document).on('click', '.product', function (e) {
            ...
            code = $(this).val(),
                ...
                cu = $('#poscustomer').val();
            if(!wh) {
                bootbox.alert('<?=lang('select_warehouse_first')?>');
                $('#modal-loading').hide();
                return
            }
            $.ajax({
        ...
        $(document).on('change', '.paid_by', function () {
            ...
            if (p_val == 'cash' || p_val == 'other') {
                ...
                $('.ppoint_' + pa_no).hide();
                $('#amount_' + pa_no).attr("readonly",false);
                ...
                $('.pcash_' + pa_no).hide();
                $('.ppoint_' + pa_no).show();
                $('#input_point_' + pa_no).focus();
                $('#amount_' + pa_no).attr("readonly",true);
            }else {
                $('.pcheque_' + pa_no).hide();
                $('.pcc_' + pa_no).hide();
                $('.pcash_' + pa_no).hide();
            ...
            $("#input_point_"+pa_no).on("keyup", function (e) {
                if(typeof $(this).attr('max') !== typeof undefined && $(this).attr('max')!==false){
                    var max = parseInt($(this).attr('max'));
                    if ($(this).val() > max){
                        $(this).val(max);
                    }
                    val_sumPoint=calcPoint(null,$(this).val()).count_point;
                    $('#amount_'+pa_no).val(val_sumPoint).focus();
                    $(this).focus();
                }
            });
        });
        ...
        function formatSearch(item) {
            ...
            var $returnString = $('<span><b>' + selectionText[0] + '</b>  (' + selectionText[1] + ')</br>' + selectionText[2] + '</span>');
            return $returnString;
        };
...
<script type="text/javascript" src="<?=$assets?>pos/js/plugins.min.js?v=<?=FORCAPOS_VERSION?>"></script>
<script type="text/javascript" src="<?=$assets?>pos/js/parse-track-data.js?v=<?=FORCAPOS_VERSION?>"></script>
<script type="text/javascript" src="<?=$assets?>pos/js/pos.ajax.js?v=<?=FORCAPOS_VERSION?>"></script>
<?php if ($pos_settings->java_applet) {
    ?>
    <script type="text/javascript" src="<?=$assets?>pos/qz/js/deployJava.js?v=<?=FORCAPOS_VERSION?>"></script>
    <script type="text/javascript" src="<?=$assets?>pos/qz/qz-functions.js?v=<?=FORCAPOS_VERSION?>"></script>
    <script type="text/javascript">
...
<!-- <script async defer src="https://maps.googleapis.com/maps/api/js?callback=initMap&libraries=places&key=<?php echo _KEY_MAP?>" type="text/javascript"></script> -->
