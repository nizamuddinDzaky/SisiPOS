...
<div id="wrapper">
    ...
    <div id="receipt-data">
        <div class="text-center">
             <img src="<?= avatar_image($this->session->userdata('avatar'), $this->session->userdata('gender')) ?>" alt="<?= $biller->company != '-' ? $biller->company : $biller->name; ?>">
            <h3 style="text-transform:uppercase;"><?= $warehouse->name;?></h3>
            <?php
            	echo "<p>" . $warehouse->address .
            	"<br>" . lang("tel") . ": " . $warehouse->phone . "<br>";
