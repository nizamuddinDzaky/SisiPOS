...
//                            }
                    ...
                    <div class="form-group all">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <i class="font-italic text-danger small">Selling Price : Rp 200000</i>
                            </div>
                            <div class="col-md-6">
                                ...
                                <i class="font-italic text-danger small">Credit Value : Rp 200000</i>
                            </div>
                    ...
                    <div class="form-group all class-selector">
                        ...
                        <span id="InfoImageProduct"><i style="color:red;"><sup><strong>*Recomended : </strong><?= "Width:".$this->Settings->iwidth."px, Height:".$this->Settings->iheight."px, Max File Size:".$this->allowed_file_size ?>Kb</sup></i></span>
                    </div>
                    ...
                    <div class="form-group all class-selector-image">
                        ...
                        <span id="InfoImageGalery"><i style="color:red;"><sup><strong>*Recomended : </strong><?= "Width:".$this->Settings->twidth."px, Height:".$this->Settings->theight."px, Max File Size:".$this->allowed_file_size ?>Kb</sup></i></span>
                    </div>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <label for="public" class="padding05"><?= lang('Tampilkan Di Ecomerce') ?></label>
                    </div>
                    <div class="row" id="extras-public" style="display: none;">
                        <div class="col-md-4">
                            <div class="form-group all">
                                <?= lang('Harga Online', 'price_online') ?>
