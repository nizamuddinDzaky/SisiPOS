...
<div class="box">
    <div class="box-header">
        ...
        <div class="box-icon">
            <?php echo anchor('https://helpdesk.forca.id/redmine/projects/forcapos-wiki/wiki/Edit_Produk', '<i class="icon fa fa-book tip" data-placement="left" title="' . lang("manual_book") . '"></i> ', 'target="_blank"') ?>
        </div>
    </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="tab-content">
                            ...
                            <div class="row">
                                <div class="col-md-5">
                                    ...
                                    <div class="form-group all">
                                        ...
                                        <?= form_input('code', (isset($_POST['code']) ? $_POST['code'] : ($product ? $product->code : '')), 'class="form-control" id="code"  required="required" readonly="readonly"') ?>
                        ...
                        <!-- Gouping -->
                        <div id="grouping" class="tab-pane fade in">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group standard consignment">
                        ...
                        <!-- Pricing -->
                        <div id="pricing_content" class="tab-pane fade in">
                            <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="form-group all">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <?= form_input('credit_price', (isset($_POST['credit_price']) ? $_POST['credit_price'] : ($product ? $this->sma->formatDecimal($product->credit_price) : '')), 'class="form-control tip number-only" id="credit_price" required="required"') ?>
                        ...
                        <!-- Settings -->
                        <div id="setting_content" class="tab-pane fade in">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group all">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div id="extras-public" <?= $product->public ? '' : ' style="display:none;"'; ?>>
                                        <div class="col-md-12">
                                            <div class="col-md-4">
                                                <div class="form-group all">
                                                    <?= lang('Harga Online', 'price_online') ?>
                                                    <?= form_input('price_online', set_value('promo_price', $product->price_public ? $product->price_public : ''), 'class="form-control tip number-only" id="price_online"') ?>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group all">
                                                    <?= lang('Berat Barang /Kg', 'weight') ?>
                                                    <?= form_input('weight', set_value('promo_price', $product->weight ? $product->weight : ''), 'class="form-control tip number-only" id="weight"') ?>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group all">
                                                    <?= lang('Min Pembelian', 'minqty') ?>
                                                    <?= form_input('minqty', set_value('promo_price', $product->e_minqty ? $product->e_minqty : ''), 'class="form-control tip number-only" id="minqty"') ?>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <input type="checkbox" class="checkbox" value="1" name="is_retail" id="is_retail" <?= $product->is_retail ? 'checked="checked"' : ''; ?>>
                                                        ...
                                                        foreach ($consignment as $csg) {
                                                            foreach ($warehouses as $iwh) {
                                                                if ($csg->warehouse_id == $iwh->id) {
                                                                    echo '<div class="col-md-3 col-sm-3 col-xs-3">' . $iwh->name . '<div class="form-group">' . form_input('n_qty_csgm[' . $csg->id . ']', (isset($_POST['n_qty_csgm[' . $csg->id . ']']) ? $_POST['n_qty_csgm[' . $csg->id . ']'] : ($csg->quantity ? $this->sma->formatDecimal($csg->quantity) : '0')), 'class="form-control tip number-only" id="n_qty_csgm_' . $csg->id . '"') . '</div></div>';
                                                                }
                                                            }
                                                        }
                                                    } else {
                                    ...
                                    <div class="form-group">
                                        <input name="cf" type="checkbox" class="checkbox" id="extras" <?php if ($product->cf1) {
                                ...
                                <div class="col-md-6">
                                    <div class="form-group standard">
                                        ...
                                        <div class="input-group"> <?= form_input('alert_quantity', (isset($_POST['alert_quantity']) ? $_POST['alert_quantity'] : ($product ? $this->sma->formatDecimal($product->alert_quantity) : '')), 'class="form-control tip number-only" id="alert_quantity"') ?>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        <?php } elseif ($product->cf2) { ?>
            $("#extras").iCheck("check");
            $('#extras-con').slideDown();
        <?php } elseif ($product->cf3) { ?>
            $("#extras").iCheck("check");
            $('#extras-con').slideDown();
        <?php } elseif ($product->cf4) { ?>
            $("#extras").iCheck("check");
            $("#extras-con").slideDown();
        <?php } elseif ($product->cf5) { ?>
            $("#extras").iCheck("check");
            $("#extras-con").slideDown();
        <?php } elseif ($product->cf6) { ?>
            $("#extras").iCheck("check");
            $("#extras-con").slideDown();
        <?php } else { ?>
            $("#extras-con").slideUp();
        ...
        <?= isset($_POST['public']) || $product->public ? '$("#public").iCheck("check");' : '' ?>
        ...
        <?= isset($_POST['consign']) || $consignment ? '$("#consign").iCheck("check");' : '' ?>
