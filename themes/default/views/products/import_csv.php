...
<div class="box">
    <div class="box-header">
        ...
        <div class="box-icon">
            <?php echo anchor('https://helpdesk.forca.id/redmine/projects/forcapos-wiki/wiki/Impot_CSV_Produk', '<i class="icon fa fa-book tip" data-placement="left" title="'.lang("manual_book").'"></i> ', 'target="_blank"') ?>
        </div>
    </div>
