...
<head>
    ...
    <link rel="stylesheet" href="<?= $assets; ?>styles/theme.css?v=<?=FORCAPOS_VERSION?>" type="text/css" charset="utf-8">
    <link rel="stylesheet" href="<?= $assets; ?>styles/style.css?v=<?=FORCAPOS_VERSION?>" type="text/css" charset="utf-8">
    <style>
        body {
            font-size: 13px;
            text-align: center;
