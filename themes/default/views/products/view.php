...
<!--                <div class="box-icon">
                ...
                <div class="box-icon">
                    <ul class="btn-tasks">
                        ...
                        <li class="dropdown">
                            <a href="<?php echo site_url('products/sync_product/'.$product->id); ?>" class="tip" data-toggle="modal" data-target="#myModal"  data-backdrop="static" title="<?= lang('configure_product_to_distributor') ?>">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="row">
                            <div class="col-sm-5">
                                ...
                                <img src="<?= url_image_thumb($product->image) ?>"
                                     alt="<?= $product->name ?>" class="img-responsive img-thumbnail"/>

                                <div id="multiimages" class="padding10">
                                    <?php if (!empty($images)) {
                                        echo '<a class="img-thumbnail" data-toggle="lightbox" data-gallery="multiimages" data-parent="#multiimages" href="'.url_image_thumb($product->image, false). '" style="margin-right:5px;"><img class="img-responsive" src="' .url_image_thumb($product->image). '" alt="' . $product->image . '" style="width:' . $Settings->twidth . 'px; height:' . $Settings->theight . 'px;" /></a>';
                                        foreach ($images as $ph) {
                                            echo '<div class="gallery-image"><a class="img-thumbnail" data-toggle="lightbox" data-gallery="multiimages" data-parent="#multiimages" href="'.url_image_thumb($ph->photo, false).'" sty le="margin-right:5px;"><img class="img-responsive" src="'.url_image_thumb($ph->photo).'" alt="'.url_image_thumb($ph->photo, false).'" style="width:' . $Settings->twidth . 'px; height:' . $Settings->theight . 'px;" /></a>';
                                ...
                                <div class="table-responsive">
                                    <table class="table table-borderless table-striped dfTable table-right-left">
                                        ...
                                        <tr>
                                            ...
                                            <td style="width:70%;">
                                                <?php echo $this->sma->save_barcode($product->code, $product->barcode_symbology, 66, false); ?>
    ...
    <script>
        $('#sync_product').click(function(){
            $.ajax({
                url: site.base_url+'official/register_product',
                type: 'GET',
                data: {
                    name: '<?= $product->name ?>',
                    supplier: <?= $product->supplier1 ?>,
                    id: <?= $product->id ?>
                },
                dataType: 'json',
