...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        <?php if ($inv) { ?>
            ...
            localStorage.setItem('no_si_spj', '<?= isset($_POST['no_si_spj']) ? $_POST['no_si_spj'] : $inv->sino_spj ?>');
            localStorage.setItem('no_si_do', '<?= isset($_POST['no_si_do']) ? $_POST['no_si_do'] : $inv->sino_do ?>');
            localStorage.setItem('no_si_so', '<?= isset($_POST['no_si_so']) ? $_POST['no_si_so'] : $inv->sino_so ?>');
            localStorage.setItem('no_si_billing', '<?= isset($_POST['no_si_billing']) ? $_POST['no_si_billing'] : $inv->sino_billing ?>');
            localStorage.setItem('delivery_date', '<?= isset($_POST['delivery_date']) ? date($dateFormats['php_ldate'], strtotime($_POST['delivery_date'])) : date($dateFormats['php_ldate'], strtotime($inv->shipping_date)); ?>');
            localStorage.setItem('receiver', '<?= isset($_POST['acceptor']) ? $_POST['acceptor'] : $purchase->receiver ?>');
            localStorage.setItem('poitems', JSON.stringify(<?= $inv_items; ?>));
            if (parseFloat(localStorage.getItem('potax2')) >= 1 || localStorage.getItem('podiscount').length >= 1 ||
            ...
            localStorage.setItem('poitems', JSON.stringify(<?= $inv_items; ?>));
        <?php } ?>
        <?php if ($purchase->sino_spj) { ?>
            // $("#no_si_spj").attr('readonly','readonly');
            $('#extras').iCheck('check');
            $('#extras-con').show();
        <?php } ?>
        <?php if ($purchase->sino_do) { ?>
            // $("#no_si_do").attr('readonly','readonly');
            $('#extras').iCheck('check');
            $('#extras-con').show();
        <?php } ?>
        <?php if ($purchase->sino_so) { ?>
            // $("#no_si_so").attr('readonly','readonly');
            $('#extras').iCheck('check');
            $('#extras-con').show();
        <?php } ?>
        <?php if ($purchase->sino_billing) { ?>
            // $("#no_si_billing").attr('readonly','readonly');
            $('#extras').iCheck('check');
            $('#extras-con').show();
        <?php } ?>
                            ...
                            <div class="row" id="extras-con" style="display: none;">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php echo form_input('no_si_spj', (isset($_POST['no_si_spj']) ? $_POST['no_si_spj'] : $purchase->sino_spj), 'class="form-control tip" data-trigger="focus" data-placement="top" title="' . lang('no_si_spj') . '" id="no_si_spj"'); ?>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php echo form_input('no_si_do', (isset($_POST['no_si_do']) ? $_POST['no_si_do'] : $purchase->sino_do), 'class="form-control tip" data-trigger="focus" data-placement="top" title="' . lang('no_si_do') . '" id="no_si_do"'); ?>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php echo form_input('no_si_so', (isset($_POST['no_si_so']) ? $_POST['no_si_so'] : $purchase->sino_so), 'class="form-control tip" data-trigger="focus" data-placement="top" title="' . lang('no_si_so') . '" id="no_si_so"'); ?>
                                        <span><i style="color:red;"><sup>Contoh : 0704361940</sup></i></span>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php echo form_input('no_si_billing', (isset($_POST['no_si_billing']) ? $_POST['no_si_billing'] : $purchase->sino_billing), 'class="form-control tip" data-trigger="focus" data-placement="top" title="' . lang('no_si_billing') . '" id="no_si_billing"'); ?>
                                        <span><i style="color:red;"><sup>Contoh : 0704361940</sup></i></span>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <?php echo form_input('delivery_date', (isset($_POST['delivery_date']) ? $_POST['delivery_date'] : ($purchase->shipping_date ? $this->sma->hrld($purchase->shipping_date) : NULL)), 'class="form-control input-tip datetime" data-trigger="focus" data-placement="top" title="' . lang('delivery_date') . '" id="delivery_date" placeholder=""'); ?>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <?php echo form_input('acceptor', (isset($_POST['acceptor']) ? $_POST['acceptor'] : $purchase->receiver), 'class="form-control tip" data-trigger="focus" data-placement="top" title="' . lang('receiver') . '" id="receiver" placeholder=""'); ?>
                                        <span><i style="color:red;"><sup>&nbsp;</sup></i></span>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <?php echo form_input('license_plate', (isset($_POST['license_plate']) ? $_POST['license_plate'] : $purchase->license_plate), 'class="form-control tip" data-trigger="focus" data-placement="top" title="' . lang('license_plate') . '" id="license_plate" placeholder=""'); ?>
