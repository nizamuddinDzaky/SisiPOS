            ...
            <div class="row padding10">
                ...
                <div class="col-xs-5">
                    ...
                    <?php
                        ...
                        echo "<p>";
                        if ($inv->sino_spj != "-" && $inv->sino_spj != "") {
                            echo "<br>" . lang("no_si_spj") . "&emsp;&emsp;&nbsp;&nbsp;: " . $inv->sino_spj;
                        }
                        if ($inv->sino_do != "-" && $inv->sino_do != "") {
                            echo "<br>" . lang("no_si_do") . "&emsp;: " . $inv->sino_do;
                        }
                        if ($inv->sino_so != "-" && $inv->sino_so != "") {
                            echo "<br>" . lang("no_si_so") . "&emsp;&emsp;&nbsp;&nbsp;: " . $inv->sino_so;
                        }
                        if ($inv->sino_billing != "-" && $inv->sino_billing != "") {
                            echo "<br>" . lang("no_si_billing") . "&emsp;: " . $inv->sino_billing;
                        }
                    ?>
                    <div class="clearfix"></div>
                </div>
