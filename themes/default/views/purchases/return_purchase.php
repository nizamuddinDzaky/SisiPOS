...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $(document).on("focus", '.rquantity', function () {
            ...
            if (!is_numeric(new_qty) || (new_qty > reitems[item_id].row.received)) {
