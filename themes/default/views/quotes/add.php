...
<script type="text/javascript">
    ...
    <?php if (!$Owner && !$Admin && $this->session->userdata('warehouse_id')) { ?>
        $(window).on('load', function () {
            $("#quwarehouse").val(<?=$this->session->userdata('warehouse_id')?>);
        })
    <?php } ?>
...
<div class="box">
    <div class="box-header">
        ...
        <div class="box-icon">
            <?php echo anchor($mb_add_quote, '<i class="icon fa fa-book tip" data-placement="left" title="'.lang("manual_book").'"></i> ', 'target="_blank"') ?>
        </div>
    </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?php echo form_input('reference_no', (isset($_POST['reference_no']) ? $_POST['reference_no'] : $qunumber), 'class="form-control input-tip" id="quref" readonly="readonly"'); ?>
                            </div>
                        </div>
