...
<script>
    $(document).ready(function () {
        var oTable = $('#QUData').dataTable({
            ...
            "aoColumns": [{"bSortable": false,"mRender": checkbox}, {"mRender": fld}, null, null, null, null, {"mRender": currencyFormat}, {"mRender": row_status}, {"bSortable": false,"mRender": validate_url}, {"bSortable": false}],
    ...
    <div class="box-header">
        ...
        <div class="box-icon">
            <ul class="btn-tasks">
                ...
                <?php } ?>
                <?php echo anchor($mb_quotes, '<i class="icon fa fa-book tip" data-placement="left" title="'.lang("manual_book").'"></i> ', 'target="_blank"') ?>
            </ul>
        </div>
    </div>
                ...
                <div class="table-responsive">
                    <table id="QUData" class="table table-bordered table-hover table-striped">
                        ...
                        <tr class="active">
                            ...
                            <th></th><th></th><th></th><th></th><th></th><th><?=lang('total');?></th><th></th>
                            <th style="min-width:30px; width: 30px; text-align: center;"><i class="fa fa-chain"></i></th>
                            <th style="width:115px; text-align:center;"><?= lang("actions"); ?></th>
                        </tr>
                        </tfoot>
