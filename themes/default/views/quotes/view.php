            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        ...
                        <li>
                            <a href="<?= site_url('quotes/email/' . $inv->id) ?>" data-target="#myModal"  data-backdrop="static" data-toggle="modal">
        ...
        <?php if (!$Supplier || !$Customer) { ?>
            <div class="buttons">
                ...
                <div class="btn-group btn-group-justified">
                    ...
                    <div class="btn-group">
                        <a href="<?= site_url('quotes/email/' . $inv->id) ?>" data-toggle="modal" data-target="#myModal"  data-backdrop="static" class="tip btn btn-info tip" title="<?= lang('email') ?>">
