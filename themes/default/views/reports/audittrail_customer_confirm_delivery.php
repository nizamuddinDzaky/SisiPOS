<script>
    $(document).ready(function() {
        $('#SLData').dataTable({
            ...
            'bProcessing': false,
            'bServerSide': true,
            'sAjaxSource': '<?= site_url('reports/get_audittrail_customer_confirm_delivery/') ?>',
            'fnServerData': function(sSource, aoData, fnCallback) {
                ...
                for (var i = 0; i < arrurl.length; i++) {
                    if (arrurl[i] == 'get_audittrail_customer_confirm_delivery') {
                ...
                $('#start_date').change(function() {
                    ...
                    for (var i = 0; i < arrayURL.length; i++) {
                        if (arrayURL[i] == 'get_audittrail_customer_confirm_delivery') {
...
<?php echo form_open("reports/audittrail_customer_confirm_delivery_action"); ?>
<div class="box">
