<script>
    $(document).ready(function() {
        $('#SLData').dataTable({
            ...
            'bProcessing': false,
            'bServerSide': true,
            'sAjaxSource': '<?= site_url('reports/get_audittrail_customer_create_order/') ?>',
            'fnServerData': function(sSource, aoData, fnCallback) {
                ...
                for (var i = 0; i < arrurl.length; i++) {
                    if (arrurl[i] == 'get_audittrail_customer_create_order') {
                ...
                $('#start_date').change(function() {
                    ...
                    for (var i = 0; i < arrayURL.length; i++) {
                        if (arrayURL[i] == 'get_audittrail_customer_create_order') {
...
<?php echo form_open("reports/audittrail_customer_create_order_action"); ?>
<div class="box">
