<script>
    $(document).ready(function() {
        $('#SLData').dataTable({
            ...
            'bProcessing': false,
            'bServerSide': true,
            'sAjaxSource': '<?= site_url('reports/get_audittrail_customer_registration/') ?>',
            'fnServerData': function(sSource, aoData, fnCallback) {
                ...
                for (var i = 0; i < arrurl.length; i++) {
                    if (arrurl[i] == 'get_audittrail_customer_registration') {
                ...
                $('#start_date').change(function() {
                    ...
                    for (var i = 0; i < arrayURL.length; i++) {
                        if (arrayURL[i] == 'get_audittrail_customer_registration') {
...
<?php echo form_open("reports/audittrail_customer_registration_action"); ?>
<div class="box">
