<script>
    $(document).ready(function() {
        $('#SLData').dataTable({
            ...
            'bProcessing': false,
            'bServerSide': true,
            'sAjaxSource': '<?= site_url('reports/get_audittrail_distributor_approve_reject_payment/') ?>',
            'fnServerData': function(sSource, aoData, fnCallback) {
                ...
                for (var i = 0; i < arrurl.length; i++) {
                    if (arrurl[i] == 'get_audittrail_distributor_approve_reject_payment') {
                ...
                $('#start_date').change(function() {
                    ...
                    for (var i = 0; i < arrayURL.length; i++) {
                        if (arrayURL[i] == 'get_audittrail_distributor_approve_reject_payment') {
...
<?php echo form_open("reports/audittrail_distributor_approve_reject_payment_action"); ?>
<div class="box">
                    ...
                    <table id="SLData" class="table table-bordered table-hover table-striped">
                        <thead>
                            <tr class="active">
                                ...
                                <th><?= lang("customer_payment_ref"); ?></th>
                                <th><?= lang("purchase_payment_ref"); ?></th>
                                <th><?= lang("sale_payment_ref"); ?></th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
