                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="small-box padding1010 bblue">
                            <div class="inner clearfix">
                                <a>
                                    <h3><?= $total_sales->total ? $total_sales->total : '0' ?></h3>
                    ...
                    <div class="col-sm-4">
                        <div class="small-box padding1010 borange">
                            <div class="inner clearfix">
                                <a>
                                    <h3><?= $total_returns->total ? $total_returns->total : '0' ?></h3>
    ...
    <div id="sales-con" class="tab-pane fade in">
        ...
        $(document).ready(function () {
            var oTable = $('#SlRData').dataTable({
                ...
                'sAjaxSource': '<?= site_url('reports/getSalesReportRev/?v=1' . $v) ?>',
                ...
                "aoColumns": [{"mRender": fld}, null, null, null, {"bVisible": false},{"bSearchable": false,"mRender": pqFormat}, {"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": row_status}],
    ...
    <div id="payments-con" class="tab-pane fade in">
        ...
        $(document).ready(function () {
            ...
            var oTable = $('#PayRData').dataTable({
                ...
                "aoColumns": [{"mRender": fld}, null, null, {"bVisible": false}, {"bVisible": false}, {"mRender": paid_by}, {"mRender": currencyFormat}, {"mRender": row_status}],
                'fnRowCallback': function (nRow, aData, iDisplayIndex) {
                    nRow.id = aData[7];
                ...
                {column_number: 4, filter_default_label: "[<?=lang('paid_by');?>]", filter_type: "text", data: []},
                {
                    ...
                    data: [{value: 'received', label: '<?=lang('received');?>'}, {value: 'returned', label: '<?=lang('returned');?>'}, {value: 'sent', label: '<?=lang('sent');?>'}]
                },
            ], "footer");
        });
        </script>
    ...
    $(document).ready(function () {
        var oTable = $('#QuRData').dataTable({
            ...
            {column_number: 4, filter_default_label: "[<?=lang('product_qty');?>]", filter_type: "text", data: []},
            {
                ...
                data: [{value: 'pending', label: '<?=lang('pending');?>'}, {value: 'sent', label: '<?=lang('sent');?>'}, {value: 'completed', label: '<?=lang('completed');?>'}]
            },
        ], "footer");
    });
    </script>
...
<div id="deposits-con" class="tab-pane fade in">
    ...
    <div class="box">
        <div class="box-header">
            <h2 class="blue"><i class="fa-fw fa fa-heart-o nb"></i><?=  lang('deposits'); ?>
            </h2>
...
$(document).ready(function () {
    $('#pdf').click(function (event) {
        ...
        window.location.href = "<?=site_url('reports/getSalesReportRev/')?>-/-/pdf/?v=1<?=$v?>";
        return false;
    });
    $('#xls').click(function (event) {
        event.preventDefault();
        window.location.href = "<?=site_url('reports/getSalesReportRev/')?>-/-/0/pdf/?v=1<?=$v?>";
        return false;
    });
