...
<script>
    $(document).ready(function () {
        ...
        var oTable = $('#PayRData').dataTable({
            ...
            "aoColumns": [{"mRender": fld}, null, {"mRender": ref}, {"mRender": ref},{"mRender": ref}, {"mRender": paid_by}, {"mRender": currencyFormat}, {"mRender": row_status}, {"bVisible": false}],
            ...
            {column_number: 4, filter_default_label: "[<?=lang('consignment_ref');?>]", filter_type: "text", data: []},
