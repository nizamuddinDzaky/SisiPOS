...
<script>
    $(document).ready(function () {
        var oTable = $('#CusData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('reports/getpiutang') ?>',
...
<ul class="nav nav-tabs no-print">
    <li class=""><a href="<?= site_url('reports/piutang/pos') ?>" class="tab-grey"><?= lang('standard_sale') ?></a></li>
    <li class="active"><a href="#" class="tab-grey"><?= lang('aksestoko_sale') ?></a></li>
</ul>
<div class="box">
