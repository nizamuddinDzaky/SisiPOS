...
if ($this->input->post('consignment')) {
    $v .= "&consignment=" . $this->input->post('consignment');
}
?>
<script>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <?php
                                $opts = array(true => lang('consignment'), false => lang('no-consignment'));
                                echo form_dropdown('consignment', $opts, (isset($_POST['consignment']) ? $_POST['consignment'] : false), 'class="form-control" id="consignment" ');?>
                                <?php // echo form_input('consignment', (isset($_POST['consignment']) ? $_POST['consignment'] : ""), 'class="form-control" id="consignment"'); ?>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
