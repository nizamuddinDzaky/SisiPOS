...
<script>$(document).ready(function () {
        CURI = '<?= site_url('reports/profit_loss'); ?>/<?=$consignment?>';
    });</script>
<style>@media print {
        .fa {
            color: #EEE;
...
<div class="box">
    <div class="box-header">
        ...
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown ">
                    <div class="tip" title="<?= lang('consignment')?>">
                        
                    <!--</div>-->
                    <!--<a href="#" id="pdf" class="tip" title="<?= lang('download_pdf') ?>">-->
                    <!--<i class="icon"><input type="checkbox" style="width: 100%" id="consignment" <?php echo $consignment?'checked':''?>/></i>-->
                    <!--</a>-->
                    </div>
                </li>
                <li class="dropdown">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="form-group">
                    <div class="col-sm-12">
                    <?php $opts = array(0 => lang('no_consignment'), 1=>lang('consignment'), 2=>lang('all'));
                    echo form_dropdown('consignment', $opts, (isset($consignment) ? $consignment : false), 'class="form-control" id="consignment" required="required"');?>
                    </div>
                </div>
                <?php
                form_close();
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#consignment').change(function(){
            window.location.href=site.base_url+"reports/profit_loss/"+$(this).val();
        });
//        $('#consignment').on('ifChecked', function () {
//            window.location.href="<?=site_url('reports/profit_loss')?>/1";
//        });
//        $('#consignment').on('ifUnchecked', function () {
//            window.location.href="<?=site_url('reports/profit_loss')?>/0";
//        });
    });
</script>
