    ...
    $(document).ready(function () {
        var oTable = $('#PoRData').dataTable({
            ...
            'fnServerData': function (sSource, aoData, fnCallback) {
                ...
                // console.log($.param($('#form').serializeObject()))
                URLtemp = sSource;
            ...
            {column_number: 3, filter_default_label: "[<?=lang('supplier');?>]", filter_type: "text", data: []},
            {
                ...
                data: [{value: 'received', label: '<?=lang('Received');?>'}, {value: 'pending', label: '<?=lang('Pending');?>'}]
            },
    ...
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-star"></i><?= lang('purchases_report'); ?> <?php
            if ($this->input->post('start_date')) {
                ...
                echo lang('from') ." ". date('01/m/Y 00:00') ." ". lang('to') ." ". date('d/m/Y H:i');
            }
            ?></h2>
...
<!--                 <div class="form-group">
                    <div class="row" id="m-y-filter" style="margin-bottom:10px;">
                        <div class="col-lg-9">
                            <?php
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <?php echo form_input('start_date', (isset($_POST['start_date']) ? $_POST['start_date'] : date('01/m/Y 00:00')), 'class="form-control datetime" id="start_date"'); ?>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                                <?= lang("end_date", "end_date"); ?>
                                <?php echo form_input('end_date', (isset($_POST['end_date']) ? $_POST['end_date'] : date('d/m/Y H:i')), 'class="form-control datetime" id="end_date"'); ?>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
