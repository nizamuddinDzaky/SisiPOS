...
<script>
    $(document).ready(function () {
        $('#SLData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('reports/get_quantum_sale_by_date') ?>',
            'fnServerData': function (sSource, aoData, fnCallback) {
                ...
                for (var i = 0; i < arrurl.length; i++) {
                    if (arrurl[i] == 'get_quantum_sale_by_date') {
                ...
                $('#start_date').change(function(){
                    ...
                    for (var i = 0; i < arrayURL.length; i++) {
                        if (arrayURL[i] == 'get_quantum_sale_by_date') {
...
<?php echo form_open("reports/get_quantum_sale_by_date"); ?>
<div class="box">
