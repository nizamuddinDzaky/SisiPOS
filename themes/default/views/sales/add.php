...
<div class="box">
    <div class="box-header">
        ...
        <div class="box-icon">
            <?php echo anchor($mb_add_sale, '<i class="icon fa fa-book tip" data-placement="left" title="'.lang("manual_book").'"></i> ', 'target="_blank"') ?>
        </div>
    </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-12" id="submit-guide">
                            ...
                            <div class="fprom-group"><?php echo form_button('add_sale', lang("submit"), 'id="add_sale" class="btn btn-primary"  style="padding: 6px 15px; margin:15px 0;"'); ?>
