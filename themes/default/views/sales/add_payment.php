                                ...
                                <div class="payment">
                                    <div class="form-group">
                                        ...
                                        <input name="amount-paid" type="text" id="amount_1"
                                               ...
                                               data-remaining="<?=$this->sma->formatDecimal($inv->grand_total - $inv->paid);?>"/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
...
<!--                                        <input name="pcc_month" type="number" id="pcc_month_1" class="form-control"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input name="pcc_year" type="number" id="pcc_year_1" class="form-control"
                                               placeholder="<?= lang('year') ?>" id="pcc_year_1"/>
                                    </div>
                                </div>
                                <!--<div class="col-md-3">
                                    <div class="form-group">
