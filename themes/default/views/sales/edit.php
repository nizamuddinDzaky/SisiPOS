...
<?php 
    $disabled = $inv->client_id == 'aksestoko' ? 'disabled' : '';
    $readonly = $inv->client_id == 'aksestoko' ? 'readonly' : '';
    // $disabledWarehouse = 
?>
                    ...
                    <div class="col-lg-12">
                                    ...
                                    <?php if ($Owner || $Admin || !$this->session->userdata('warehouse_id')) { ?>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                echo form_dropdown('warehouse', $wh, (isset($_POST['warehouse']) ? $_POST['warehouse'] : $inv->warehouse_id), 'id="slwarehouse" class="form-control input-tip select" data-placeholder="' . lang("select") . ' ' . lang("warehouse") . '" required="required" style="width:100%;" '. ($inv->sale_status != 'pending' ? 'disabled"': '').'');
                                                ?>
                                            </div>
                                        </div>
                                    <?php } else {
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div class="input-group-addon" style="padding-left: 10px; padding-right: 10px;">
                                                    <a href="javascript:void(0)" id="<?=$inv->client_id == 'aksestoko' ? '' :'removeReadonly'?>">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <?php echo form_input('payment_term', '', 'class="form-control tip" data-trigger="focus" data-placement="top" title="' . lang('payment_term_tip') . '" id="slpayment_term" '.$disabled.''); ?>
                        ...
                        <div class="row" id="bt">
                            <div class="col-md-12">
                                <div class="col-md-12 reason_note" style="display: none">
                                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div
                                class="fprom-group"><?php echo form_button('edit_sale', lang("submit"), 'id="edit_sale" class="btn btn-primary"  style="padding: 6px 15px; margin:15px 0;"'); ?>
