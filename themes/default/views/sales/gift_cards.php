...
<script>
    $(document).ready(function () {
        $('#GCData').dataTable({
            ...
            "aoColumns": [{"bSortable": false, "mRender": checkbox }, null, {"mRender": currencyFormat}, {"mRender": currencyFormat}, null, null, {"mRender": fldd}, {"bSortable": false}]
        });
    });
</script>
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?php echo site_url('sales/add_gift_card'); ?>" data-toggle="modal" data-target="#myModal"  data-backdrop="static">
                ...
                <div class="table-responsive">
                    <table id="GCData" class="table table-bordered table-hover table-striped">
                        ...
                        <tr>
                            ...
                            <th style="width:15px;"><?php echo $this->lang->line("value"); ?></th>
                            <th style="width:15px;"><?php echo $this->lang->line("balance"); ?></th>
