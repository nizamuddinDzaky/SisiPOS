...
<?php
$url = site_url('sales/getSales/' . date('Y') . '/' . date('m') . '/' . ($warehouse_id ? $warehouse_id : ''))
?>
<script>
    var URLtemp;
    $(document).ready(function() {
        var oTable = $('#SLData').dataTable({
            ...
            'sAjaxSource': '<?= $url ?>',
            //            'sAjaxSource': `<?= site_url('sales/getSales/') ?>/${$("annually").val()}/${$("monthly").val()}/<?= ($warehouse_id ? $warehouse_id : '') ?>`,
        ...
        <div class="box-icon">
            <ul class="btn-tasks">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li><a href="<?= $mb_sales ?>" target="_blank"><i class="fa fa-book tip"></i> <?= lang('sales') ?></a></li>
                        <li><a href="<?= $mb_edit_sale ?>" target="_blank"><i class="fa fa-book tip"></i> <?= lang('edit_sale') ?></a></li>
                        <li><a href="<?= $mb_import_csv_sales ?>" target="_blank"><i class="fa fa-book tip"></i> <?= lang('import_csv') ?></a></li>
                        <li><a href="<?= $mb_export_excel_sales ?>" target="_blank"><i class="fa fa-book tip"></i> <?= lang('export_to_excel') ?></a></li>
                    </ul>
                </li>
            </ul>
        </div>
