...
<div id="wrap">
    ...
    <div class="table-responsive">
        <table class="table table-bordered">
            ...
            <tr>
                <td><?php echo $this->lang->line("Distributor_ID"); ?></td>
        ...
        <table class="table table-bordered table-hover table-striped">
            ...
            <thead>
                <tr>
                    ...
                    <th style="text-align:center; vertical-align:middle;">Good</th>
                    <th style="text-align:center; vertical-align:middle;">Bad</th>
                </tr>
            </thead>
            ...
            foreach ($rows as $row): ?>
                <tr>
                    ...
                    <td style="width: 150px; text-align:center; vertical-align:middle;"><?= $this->sma->formatQuantity($row->quantity_sent).' '.$row->product_unit_code; ?></td>
                    <td style="text-align:center; vertical-align:middle;"><?= $this->sma->formatQuantity($row->good_quantity ).' '.$row->product_unit_code; ?></td>
                    <td style="text-align:center; vertical-align:middle;"><?= $this->sma->formatQuantity($row->bad_quantity ).' '.$row->product_unit_code; ?></td> 
                </tr>
                <?php
                $r++;
            endforeach;
