...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var oTable = $('#DOData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('sales/getDeliveries?sale_id='.$inv->id) ?>',
    ...
    <div class="col-sm-12">
        ...
        <div class="tab-content">
                                ...
                                <div class="well well-sm">
                                    <div class="col-xs-4 border-right">
                                        ...
                                        <div class="col-xs-10">
                                            ...
                                            echo "</p>";
                                            echo lang("tel") . "&emsp;&nbsp;&emsp;: " . $biller->phone . "<br>" . lang("email") . "&emsp;: " . $biller->email;
                                            ?>
                                        </div>
                                    ...
                                    <div class="col-xs-4 border-right">
                                        ...
                                        <div class="col-xs-10">
                                            ...
                                            echo "</p>";
                                            echo lang("tel") . "&emsp;&nbsp;&emsp;: " . $customer->phone . "<br>" . lang("email") . "&emsp;: " . $customer->email;
                                            ?>
                                        </div>
                                        <div class="clearfix"></div>
                                    ...
                                    <div class="col-xs-10">
                                        <table class="bold">
                                            ...
                                            <tr>
                                                ...
                                                <td> &emsp;:&emsp; </td>
                                                <td><?= lang($inv->return_sale_ref); ?>
                                                    <?php if ($inv->return_id) { ?>
                                                        <a data-target="#myModal2" data-toggle="modal" href="'.site_url('sales/modal_view/'.$inv->return_id).'"><i class="fa fa-external-link no-print"></i></a><br>
                                                    <?php } ?>
                                                </td>
                                            </tr>
                                            <?php } ?>
                                    ...
                                    <h2 class="bold" style="margin: 0; margin-bottom: 5px;">AksesToko Order Detail</h2>
                                        <table class="bold">
                                            ...
                                            <tr>
                                                <td><?= lang('due_date'); ?></td>
                                                <td> &emsp;:&emsp; </td>
                                                <td><?= ($po->payment_deadline ? $this->sma->hrsd($po->payment_deadline) : '-'); ?></td>
                                            </tr>
                                            <?php } ?>
                                            <tr>
            ...
            <div id="deliveries" class="tab-pane fade">
                <div class="box">
                    <div class="box-header">
                        <h2 class="blue"><i class="fa-fw fa fa-file"></i><?= lang("deliveries") . ' ' . $inv->reference_no; ?></h2>
                        <div class="box-icon">
                            <ul class="btn-tasks">
                                <li class="dropdown">
                                    <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                    ...
                    <div class="box-content">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="clearfix"></div>
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover table-striped print-table order-table" id="DOData">
