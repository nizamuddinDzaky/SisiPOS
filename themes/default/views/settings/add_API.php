...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                <div class="form-group">
                    ...
                    <?= form_input('username', '', 'class="form-control" id="username" required="required"'); ?>
                    <input name="code" id="username" type="hidden" />
                </div>
                <div class="form-group">
                    <label class="control-label" for="password"><?php echo $this->lang->line("password"); ?></label>
                    <?= form_input('password', '', 'class="form-control" id="password" required="required"'); ?>
            ...
            <div class="form-group">
                <div class="form-group">
                    ...
                    <?= form_input('supplier_id', '', 'class="form-control" id="supplier_id" required="required"'); ?>
                    <input name="code" id="supplier_id" type="hidden" />
                </div>
                <div class="form-group">
                    <label class="control-label" for="type"><?php echo $this->lang->line("type"); ?></label>
                    <?= form_input('type', '', 'class="form-control" id="type" required="required"'); ?>
            ...
            <div class="">
                ...
                <div class="" id="row_cf7">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <?= form_input('cf7', '', 'class="form-control" id="cf7"'); ?>
                ...
                <div class="" id="row_cf8">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <?= form_input('cf8', '', 'class="form-control" id="cf8"'); ?>
                ...
                <div class="" id="row_cf9">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <?= form_input('cf9', '', 'class="form-control" id="cf9"'); ?>
                ...
                <div class="" id="row_cf10">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <?= form_input('cf10', '', 'class="form-control" id="cf10"'); ?>
        ...
        <div class="modal-footer">
            <?php echo form_submit('add_API', lang('add_API'), 'class="btn btn-primary"'); ?>
        </div>
    </div>
    <?php echo form_close(); ?>
</div>
