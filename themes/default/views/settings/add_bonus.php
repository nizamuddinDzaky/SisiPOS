...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo lang('add_bonus'); ?></h4>
        </div>
        <?php $attrib = array('data-toggle' => 'validator', 'role' => 'form');
        echo form_open("system_settings/add_bonus", $attrib); ?>
        <div class="modal-body ui-front">
            ...
            <div class="form-group">
                ...
                <input type="checkbox" class="checkbox" name="multiply" id="multiply"/><?= lang('applies_multiply') ?></label>
            </div>
        </div>
        <div class="modal-footer">
            <?php echo form_submit('add_bonus', lang('add_bonus'), 'class="btn btn-primary"'); ?>
        </div>
    </div>
    <?php echo form_close(); ?>
</div>
<script>
    $("#product,#product_bonus").select2({
