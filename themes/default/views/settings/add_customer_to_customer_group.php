...
<script type="text/javascript">
    $(document).ready(function () {
        $('#StCaRData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('system_settings/getCustomers_cg?id_cg='.$id.$v) ?>',
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-plus-square-o"></i><?= lang('add_customer_to_customer_group'); ?> (<?= strtoupper($customer_group->name)?>)</h2>
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
    ...
    <div id="form">
        <div class="box-content">
            <div class="row">
                <div class="col-lg-12">
                    <?php echo form_open("system_settings/add_customer_to_customer_group/".$id); ?>
                    <!-- <div id="form"> -->
                        <div class="row">
                            <div class="col-md-6">
...
<div class="row">
    ...
    <div class="col-sm-4">
        <div class="box">
            ...
            <div class="box-content">
                <?php echo form_open("system_settings/save_customer_to_customer_group/".$id); ?>
                    <input type="hidden" value="<?=$customer_group->name?>" name="cg_name">
                    <div style="width: 100%; height:52vh; overflow-y: scroll;">
                        <ul id="list-toko-selected" class="list-group" style="text-align: center; width: 100%; height: 100%; background-color: #dedede;">
                            <?php
                                if ($customer_of_customer_group) {
                                    foreach ($customer_of_customer_group as $key => $cpg) {
...
<script type="text/javascript">
var data_cpg = JSON.parse(`<?= json_encode($customer_of_customer_group)?>`);
    $(document).ready(function () {
