...
<script>
    $(document).ready(function () {
        ...
        var dataTable = $('#GData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('system_settings/get_cms') ?>',
...
<div class="box">
    <div class="box-header">
        ...
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
                    <a title="Add Template CMS" class="tip" href="<?php echo site_url('system_settings/add_cms_name'); ?>" data-toggle="modal" data-target="#myModal"  data-backdrop="static">
                ...
                <div class="table-responsive">
                    <table id="GData" class="table table-bordered table-hover table-striped">
                        ...
                        <tr>
                            ...
                            <th><?= lang('Template');?></th>
                            <th style="max-width:85px;"><?php echo $this->lang->line("Status"); ?></th>
