...
<script>
    $(document).ready(function () {
        ...
        var dataTable = $('#GData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('system_settings/get_cms_faq') ?>',
...
<div class="box">
    <div class="box-header">
        ...
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
                    <a title="Add CMS Faq" class="tip" href="<?php echo site_url('system_settings/add_cms_faq'); ?>" data-toggle="modal" data-target="#myModal"  data-backdrop="static">
