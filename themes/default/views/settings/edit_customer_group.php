...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                <label for="kredit_limit"><?php echo $this->lang->line("kredit_limit"); ?></label>

                <div
                    class="controls"> <?php echo form_input('kredit_limit', $this->sma->formatDecimal($customer_group->kredit_limit), 'class="form-control" id="kredit_limit" required="required"'); ?> </div>
            </div>
        </div>
