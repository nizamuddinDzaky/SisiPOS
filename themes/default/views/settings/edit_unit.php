...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <?php if($unit->client_id!=$this->session->userdata('company_id')){
                echo "You Don't Have Right to ".lang('edit_unit');
            }else{?>
            <p><?= lang('enter_info'); ?></p>
        ...
        <?php if($unit->client_id==$this->session->userdata('company_id')){
            echo form_submit('edit_unit', lang('edit_unit'), 'class="btn btn-primary"');
        } else { ?>
