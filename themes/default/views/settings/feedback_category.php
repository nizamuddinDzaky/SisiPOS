...
<script>
    $(document).ready(function() {
        ...
        var dataTable = $('#GData').dataTable({
            ...
            'bProcessing': true,
            'bServerSide': true,
            'sAjaxSource': '<?= site_url('System_settings/getFeedbackCategory') ?>',
            ...
            "aoColumns": [{
                "bVisible": false
            }, null,{"mRender": top_status}, {"mRender": feedback_flag}, {
                "bSortable": false
            }]
        });
...
<div class="box">
    <div class="box-header">
        ...
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
                    <a title="<?= lang('add_feedback_category') ?>" class="tip" href="<?php echo site_url('system_settings/add_feedback_category'); ?>" data-toggle="modal" data-target="#myModal" data-backdrop="static">
