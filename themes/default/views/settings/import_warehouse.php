...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        echo form_open_multipart("system_settings/import_warehouse", $attrib)
        ?>
        <div class="modal-body">
            <a href="<?php echo base_url(); ?>assets/csv/sample_waehouse.csv" class="btn btn-primary pull-right">
            ...
            <div class="well well-small">
                ...
                <span class="text-info">
                    (<?= lang("code") . ', ' . lang("name") . ', ' . lang("phone"). ', ' . lang("parent_category_code").','. lang("email").','. lang("address").','. lang("id_distributor"); ?>)
                </span> <?= lang("csv3"); ?><br>
