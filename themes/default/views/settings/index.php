            ...
            <div class="col-lg-12">
                ...
                <div class="row">
                    ...
                    <fieldset class="scheduler-border">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <?= lang('stock_prefix', 'stock_prefix'); ?>
                                <?= form_input('stock_prefix', $Settings->stock_prefix, 'class="form-control tip" id="stock_prefix"'); ?>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <?= lang('consignment_prefix', 'consignment_prefix'); ?>
                                <?= form_input('consignment_prefix', $Settings->consignment_prefix, 'class="form-control tip" id="consignment_prefix"'); ?>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <?= lang('cpayment_prefix', 'cpayment_prefix'); ?>
                                <?= form_input('cpayment_prefix', $Settings->cpayment_prefix, 'class="form-control tip" id="cpayment_prefix"'); ?>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <?= lang('binvoice_prefix', 'binvoice_prefix'); ?>
                                <?= form_input('binvoice_prefix', $Settings->binvoice_prefix, 'class="form-control tip" id="binvoice_prefix"'); ?>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <?= lang('bpayment_prefix', 'bpayment_prefix'); ?>
                                <?= form_input('bpayment_prefix', $Settings->bpayment_prefix, 'class="form-control tip" id="bpayment_prefix"'); ?>
                            </div>
                        </div>
                    </fieldset>
