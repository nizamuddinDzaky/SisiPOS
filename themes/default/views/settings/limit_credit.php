...
<script>
    ...
    function load_data() {
        $('#PData').dataTable({
            ...
            'bProcessing': true,
            'bServerSide': true,
            'sAjaxSource': '<?= site_url('system_settings/getLimitCustomer') ?>',
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-gift"></i><?= lang('Limit_Credit') ?></h2>
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?php echo site_url('system_settings/add_limit'); ?>" data-toggle="modal" data-target="#myModal" data-backdrop="static">
                                <i class="fa fa-plus"></i> <?= lang('Add_Limit') ?>
                            </a>
                        </li>
                    </ul>
                </li>
                    ...
                    <table id="PData" class="table table-bordered table-hover table-striped">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo $this->lang->line("Tenor"); ?></th>
