            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?= site_url('suppliers/add'); ?>" data-toggle="modal" data-target="#myModal"  data-backdrop="static" id="add">
                                <i class="fa fa-plus-circle"></i> <?= lang("add_supplier"); ?>
                            </a>
                        </li>
                        <li>
                            <a href="<?= site_url('suppliers/import_csv'); ?>" data-toggle="modal" data-target="#myModal"  data-backdrop="static">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li><a href="<?= $mb_suppliers ?>" target="_blank"><i class="fa fa-book tip"></i> <?= lang('suppliers') ?></a></li>
                        <li><a href="<?= $mb_add_supplier ?>" target="_blank"><i class="fa fa-book tip"></i> <?= lang('add_supplier') ?></a></li>
                        <li><a href="<?= $mb_edit_supplier ?>" target="_blank"><i class="fa fa-book tip"></i> <?= lang('edit_supplier') ?></a></li>
                    </ul>
                </li>
            </ul>
        </div>
...
//    });
//    $("#tb_supp").click( function() { 
//        localStorage.setItem('flag_editSuppliers',true);
//    });
</script>
