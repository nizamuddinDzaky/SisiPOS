...
<script>
    $(document).ready(function () {
        var oTable = $('#TOData').dataTable({
            ...
            "aoColumns": [{"bSortable": false,"mRender": checkbox}, {"mRender": fld}, null, null, null, {"mRender": row_status}, {"bSortable": false,"mRender": validate_url}, {"bSortable": false}],
            ...
            {column_number: 5, select_type: 'select2',
                ...
                data: [{value: 'completed', label: '<?=lang('completed');?>'}, {value: 'pending', label: '<?=lang('pending');?>'}, {value: 'sent', label: '<?=lang('sent');?>'}]
            },
        ], "footer");
    });
</script>
    ...
    <div class="box-header">
        ...
        <div class="box-icon">
            <ul class="btn-tasks">
                ...
                <?php echo anchor($mb_transfer, '<i class="icon fa fa-book tip" data-placement="left" title="'.lang("manual_book").'"></i> ', 'target="_blank"') ?>
            </ul>
        </div>
    </div>
